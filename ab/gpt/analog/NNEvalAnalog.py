...
from ab.gpt.analog.UtilAnalog import read_py_file_as_string

from ab.gpt.util.Const import epoch_dir, new_nn_file, nngpt_dir, synth_dir, hp_file, NN_TRAIN_EPOCHS
from ab.gpt.analog.EvalAnalog import Eval
from ab.gpt.analog.UtilAnalog import verify_nn_code, copy_to_lemur
