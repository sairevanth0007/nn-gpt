...
class ICInitBlock(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = nn.Conv2d(in_channels, mid_channels, kernel_size=4, stride=2, padding=1)
...
class ICNetClassification(nn.Module):
    def __init__(self, num_classes, in_channels):
        ...
        self.psp_block = PSPBlock(64, pool_sizes=[2, 3, 5])
        self.head_block = nn.Conv2d(64, 32, kernel_size=1)
